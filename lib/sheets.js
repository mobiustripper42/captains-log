...
export async function formatRow(trip) {
  ...
  return {
    ...
    'Emergency Drills (completed 1st trip of month)?': emergencyDrills ? 'Yes' : '',
    'Number Of Passengers': trip.passenger_count ?? '',
    'Weather Forecast / Actual Conditions': trip.weather_summary ?? '',
    'Destinations and/or Stops were made at:': route?.official_name ?? '',
